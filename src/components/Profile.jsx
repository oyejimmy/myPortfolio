  ...
  return (
    <>
      ...
      <div className="px-7 py-7 flex flex-col flex-col-reverse md:flex md:flex-row md:items-center md:justify-between pt-3">
        <div className="flex flex-col gap-y-2">
          ...
          <div className="flex items-center text-center md:text-justify justify-center md:justify-normal pt-6">
            <a href={configData.hireMeLink}>
              <button
                type="button"
                className="gap-x-1 before:ease relative overflow-hidden border border-[#b9466f] bg-[#b9466f] text-white shadow-2xl transition-all before:absolute before:right-0 before:top-0 before:h-12 before:w-6 before:translate-x-12 before:rotate-6 before:bg-white before:opacity-10 before:duration-700 hover:before:-translate-x-40 font-medium rounded-lg text-sm px-2 py-2 text-center inline-flex items-center mr-2 mb-2"
              >
                <svg
        ...
        <div className="rounded-full p-1 flex items-center justify-center mb-7">
          <div className="w-36 h-36 rounded-full bg-gradient-to-b from-gray-100 to-gray-300 border-4 flex items-center justify-center">
            <img
              src={profile}
              alt=""
